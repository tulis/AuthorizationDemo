...
{
    // https://github.com/scottbrady91/Blog-Example-Classes/blob/master/EcdsaJwtSigning/ScottBrady91.BlogExampleCode.EcdsaJwtSigning/Program.cs
    public class EcdsaJwtAuthorizer : IAuthorizer
    {
